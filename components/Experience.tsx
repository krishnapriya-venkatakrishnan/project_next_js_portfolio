    ...
    <div className=" w-full max-w-7xl mx-auto">
      ...
      <div className="w-full flex max-sm:flex-col items-start justify-center gap-4 px-4">
        <div className="flex-1 flex flex-col gap-2">
          <h2 className="text-[1.125rem] lg:text-[1.25rem] font-bold 2xl:text-[1.5rem]">T24 Software Developer</h2>
        ...
        <div className="flex-1 flex flex-col gap-2">
          ...
          <p className="pb-4 max-lg:text-[0.9rem] italic">January 2020- July 2021</p>
          <ul className="flex flex-col gap-1.5 max-lg:text-[0.9rem]">
      ...
      <div className="w-full flex max-sm:flex-col items-start justify-center gap-4 px-4 mt-4">
        <div className="flex-1 flex flex-col gap-2">
          <h2 className="text-[1.125rem] lg:text-[1.25rem] font-bold 2xl:text-[1.5rem] pb-1 ">T24 Specialist</h2>
