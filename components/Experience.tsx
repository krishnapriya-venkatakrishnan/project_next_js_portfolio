    ...
    <div className="w-full max-w-7xl mx-auto">
      ...
      <div className="w-full flex max-sm:flex-col items-start justify-center gap-4 px-4">
        <div className="flex-1 flex flex-col">
          <h2 className="text-xl font-bold my-4">T24 Software Developer</h2>
          <p className="pb-4">December 2016- Decemeber 2019</p>
        ...
        <div className="flex-1 flex flex-col">
          <h2 className="text-xl font-bold my-4">T24 Software Developer</h2>
          <p className="pb-4">January 2020- July 2021</p>
          <ul className="flex flex-col gap-1.5">
      ...
      <div className="w-full flex max-sm:flex-col items-start justify-center gap-4 px-4">
        <div className="flex-1 flex flex-col">
          <h2 className="text-xl font-bold my-4">T24 Specialist</h2>
          <p className="pb-4">August 2021- June 2022</p>
          <ul className="flex flex-col gap-1.5">
        ...
        <div className="flex-1 flex flex-col">
          <h2 className="text-xl font-bold my-4">T24 Associate Lead Product Engineer</h2>
          <p className="pb-4">July 2022- December 2022</p>
          <ul className="flex flex-col gap-1.5">
